...
@SpringBootTest(
        classes = CofreSegredosEnvironmentPostProcessorRegistroBootTest.AplicacaoMinima.class,
...
class CofreSegredosEnvironmentPostProcessorRegistroBootTest {

    @Autowired
    private Environment environment;

    @Test
    void bootDescobreEnvironmentPostProcessorViaSpringFactories() {
