...
- Projeto: **SIAFIC** (Oberware) — sistema de execução orçamentário-financeiro-contábil (Decreto 10.540/2020). Fase: **F0** — scaffold + motor de razão em implementação ([docs/](docs/README.md)).
