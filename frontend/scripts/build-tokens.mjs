// Pipeline de tokens (ADR-0031): tokens/*.tokens.json (fonte, DTCG) -> build ->
// src/shared/tokens/theme.{ts,css}. Artefatos de saida sao GERADOS — nao editar a mao.
...
// Fonte: frontend/tokens/*.tokens.json (ADR-0031). Enquanto RAZ-100 (Paula)
// nao entrega os tokens reais, estes valores sao placeholder explicito.
