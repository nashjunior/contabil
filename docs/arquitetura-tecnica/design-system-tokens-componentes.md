...
**Arquivo Figma:** [SIAFIC — Design System (F1 execução)](https://www.figma.com/design/ObQu8oMQ0cEGbONMXgpuLU) (`fileKey ObQu8oMQ0cEGbONMXgpuLU`, plano "internal projects"). 12 páginas: `Cover`, `Foundations` (cor/tipografia/espaçamento/elevação), e uma página por componente — inclui `10 Aviso de Gap (API)`, adicionado durante RAZ-102 (v1 tinha 11 páginas / 10 componentes; ver linha 11 da tabela abaixo). O arquivo também contém uma página `10 Telas core F1 (RAZ-102)` com as 3 telas do operador, fora do escopo desta biblioteca.
...
Cobertura: 91 variáveis (43 primitivas + 35 semânticas + 13 espaçamento/raio), 9 text styles, 3 effect styles, 11 component sets / 27 variantes.
